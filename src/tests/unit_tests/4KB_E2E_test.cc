...
void testSerializationDeserializationE2E(int datalen)
{
...
{
    // Run the test
    testSerializationDeserializationE2E(128);
    testSerializationDeserializationE2E(1024);
    testSerializationDeserializationE2E(4096);
    testSerializationDeserializationE2E(4096 * 4);
    testSerializationDeserializationE2E(4096 * 16);
